...
kubectl taint nodes kind-worker3 app=todoapp:NoSchedule
kubectl taint nodes kind-worker4 app=todoapp:NoSchedule
kubectl taint nodes kind-worker5 app=todoapp:NoSchedule
